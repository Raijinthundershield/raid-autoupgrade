...
class UpgradeStateMachine:
    ...
    def process_frame(self, roi_image: np.ndarray) -> tuple[int, StopReason | None]:
    ...
    def _check_stop_condition(self) -> StopReason | None:
...
class UpgradeAttemptMonitor:
    ...
    def __init__(self, detector, max_attempts: int):
